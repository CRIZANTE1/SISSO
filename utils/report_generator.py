...
<body>
    ...
    <!-- Primeira foto da galeria de evidências abaixo da tabela -->
    ...
    <div style="margin-top: 15px; text-align: center; page-break-inside: avoid;">
        ...
        <div style="width: 7cm; height: 7cm; margin: 0 auto; border: 1px solid #ddd; border-radius: 4px; display: flex; align-items: center; justify-content: center; overflow: hidden; background-color: #f9f9f9;">
            <img src="{{ evidence_images[0] }}" style="max-width: 7cm; max-height: 7cm; width: auto; height: auto; object-fit: contain;" alt="Primeira evidência">
        </div>
    </div>
    {% endif %}
