...
def render_fault_tree_html(tree_json: Dict[str, Any]) -> str:
    ...
    def render_node(node: Dict[str, Any], level: int = 0) -> str:
        ...
        # Determina forma CSS (tamanhos reduzidos)
